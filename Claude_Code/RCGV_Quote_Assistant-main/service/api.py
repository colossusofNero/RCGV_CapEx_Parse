...
def quote_document(
    ...
    try:
        ...
        # Build 481(a) breakdown object for response with deterministic rounding
        current_year_by_class = round_dict_to_pennies(adjustment_481a['current_year_depreciation'])
        ...
        depreciation_481a = {
            ...
            "remaining_basis_by_class": round_dict_to_pennies(remaining_basis),
